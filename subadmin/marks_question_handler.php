...
if (isset($_POST['subject_name'])) {
    ...
    if($num==0){
        ...
        $query = "INSERT INTO `marks_question` (`subject_id`, `department_id` ,`total_question`, `easy`, `intermediate`, `hard`,`each_marks`,`total_marks`) VALUES ('$subject_id','$department','$total_question', '$easy', '$intermediate', '$hard','$each_marks','$total_marks')";
...
if(isset($_POST['start'])){
    ...
    if($updateresult){
        header('location:../admin/marks_question.php');
    }
}
