...
$department_id=mysqli_real_escape_string($conn,$_SESSION['department']);
$sub_credit=mysqli_real_escape_string($conn,$_POST['sub_credit']);
    ...
    if($num > 0){
        ...
        $sql="INSERT INTO `subject_register` (`subject_name`, `subject_category`, `subject_code`,`faculty_id`,`department_id`,`year`,`credit`) 
        VALUES ('$sub_name', '$sub_category', '$sub_code','$faculty_id','$department_id','$year','$sub_credit')";
