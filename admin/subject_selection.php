...
<body>
    ...
    <div class="content-container">
        ...
        <div class="container my-5">
            ...
            <div class="jumbotron">
                <center>
                    <h3 class="text-center">SUBJECT ALLOCATION</h3>
                </center>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="degree" class="form-control" name="degree" required>
                                    ...
                                    $abc = "SELECT * FROM degree WHERE `department_id`='$department'";
                            ...
                            <label for="inputState">CORE</label> <input type="number" name="core" placeholder="ENTER TOTAL NUMBERS" class="form-control name_list" required>

                            <label for="inputState">FOUNDATION</label> <input type="number" name="foundation" placeholder="ENTER TOTAL NUMBERS" class="form-control name_list" required>
                            <label for="inputState">ELECTIVES</label> <input type="number" name="elective" placeholder="ENTER TOTAL NUMBERS" class="form-control name_list" required>
