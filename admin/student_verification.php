        ...
        <div class="container my-5">
            ...
            <table id="msg" class="data my-3 table-bordered table table-hover text-center">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM `student_register` WHERE department_id=$department";
          ...
          <option value="" disabled selected hidden>View Subjects</option>';
                      ...
                      <option disabled>' . $subject . '</option>';
                        ...
                        if ($row['verification_status'] == 1) {
                            echo '</select></td><td><button style="font-size:12px;" type="submit" name="submit" class="btn btn-success submit active" disabled>VERIFIED</button></td>
                ...
                ';
                            ...
                            echo '</select></td><td><button  style="font-size:12px;" type="submit" name="submit" class="btn btn-success submit active">VERIFY</button></td>
                <td><a href="#" class=" delete-btn  active" role="button" data-id="' . $prn . '" aria-pressed="true"><i class="fas fa-2x fa-trash" style="color: red;"></i></a></td>
