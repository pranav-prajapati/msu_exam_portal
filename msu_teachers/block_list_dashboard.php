...
<body>
    ...
    <?php include 'top_navbar.php'; ?>
        <div class="container my-5 ">
            <h3 class="text-center" style="text-transform:uppercase;"> LIST OF BLOCKED STUDENTS </h3>
            ...
            <table class="data my-3 table-bordered table table-hover text-center">
                <thead>
                    <tr>
                        ...
                        <th> SUBJECT CODE </th>
                        <th> DATE </th>
                        <th> BLOCKED STUDENTS / TOTAL STUDENTS </th>
                        <th> ACTION </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    while ($rowx = mysqli_fetch_assoc($abc)) {
                        ...
                        $sql3 = mysqli_query($conn, "SELECT DISTINCT student_id FROM block_list WHERE `subject_id`='$subject_id'");
                        ...
                        echo '
                                <tr>
                                        ...
                                        <td><a href="blocklist.php?subject_name=' . htmlspecialchars($rowx['subject_name']) . '"> <i class="far fa-2x fa-eye"></i></a></td>
                                </tr>';
