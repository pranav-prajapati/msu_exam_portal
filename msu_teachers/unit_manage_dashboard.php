...
<body>
    ...
    <?php include 'top_navbar.php'; ?>
        <div class="container my-5 ">
            <h2 class="text-center" style="text-transform:uppercase;"> UNIT MANAGEMENT </h2>
                    ...
                    while ($rowx = mysqli_fetch_assoc($abc)) {
                        ...
                        echo '
                                <tr>
                                        ...
                                        <td>' .  $total . '</td>
                                        <td><a href="unit_manage.php?subject_name=' . htmlspecialchars($rowx['subject_name']) . '"> <i class="far fa-2x fa-eye"></i></a></td>
                                </tr>';
