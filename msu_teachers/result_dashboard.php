...
<body>
    ...
    <?php include 'top_navbar.php'; ?>
        <div class="container my-5 ">
            <h2 class="text-center" style="text-transform:uppercase;"> RESULT </h2>
                    ...
                    while ($rowx = mysqli_fetch_assoc($abc)) {
                        ...
                        echo '
                                <tr>
                                        ...
                                        <td><a href="result.php?subject_name=' . htmlspecialchars($rowx['subject_name']) . '"> <i class="far fa-2x fa-eye"></i></a></td>
                                </tr>';
