...
<body>
            ...
            <div class="container">
                ...
                <table class="data my-3 table-bordered table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        $unit = "SELECT * FROM marks_question";
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            <td style="text-transform: uppercase;" data-target="department_name"><label style="font-size: 12px; ">
                                 ' . htmlspecialchars($department_name) . '</td>
                        ...
                        <form action="marks_question_handler.php" method="POST">
                            ...
                            if ($statusrow['exam_status'] == 0) {
                                echo '<td style="text-transform: uppercase;" data-target="start"><button type="submit"
                              ...
                              name="cancel" class="btn btn-outline-danger">CANCEL</button>
                              </td>';
                            }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ADD EXAM DETAILS</h5>
                ...
                <form id="register">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select subname  mb-3" id="subject_name" name="subject_name" required>
                                ...
                                $abc = "SELECT * FROM subject_register WHERE `subject_id`='$subject_id' AND `faculty_id`='$faculty'";
                        ...
                        <div class="form-row my-3">
                            <div class="col-md-5">
                                ...
                                <input class="form-control dynamic" id="each_marks" name="each_marks" type="number" required>
                            </div>
                            <div class="form-group col-md-7">
                                <label>TOTAL MARKS</label>
                                <input class="form-control" name="total_marks" id="total_marks" type="number" required disabled>
                            </div>
                        </div>
                        <hr>
    ...
    function formregistration() {
        ...
        registrationform.onsubmit = async (e) => {
            ...
            if (res == 1) {
                window.location.assign('../super_admin/marks_question.php')
            }
