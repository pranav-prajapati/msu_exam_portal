            ...
            <div class="jumbotron">
                ...
                <form id="register2">
                    <select class="form-control" name="department_id">
                        ...
                        <?php
                        $sq = mysqli_query($conn, "SELECT * FROM department");
                        while ($re = mysqli_fetch_assoc($sq)) {
                            echo '<option value="' . $re['department_id'] . '">' . $re['department_name'] . '</option>';
                        }
                    ...
                    <center><input type="submit" name="sub2" id="submit2" class="my-3 btn btn-info" value="SUBMIT" onclick="formregistration2()" />
                    ...
                    <div class="jumbotron">
                        ...
                        <form id="register3">
                            <div>
                                ...
                                <br>
                                <input type="text" id="fy" name="fy" class="my-1 form-control" placeholder="FOR FIRST YEAR" required>

                                <input type="text" id="sy" name="sy" class="my-1 form-control" placeholder="FOR SECOND YEAR" required>


                                <input type="text" id="ty" name="ty" class="my-1 form-control" placeholder="FOR THIRD YEAR" required>




                                <center><input type="submit" id="submit3" class="my-3 btn btn-outline-info" value="SUBMIT" onclick="formregistration3()" />
...
<!-- post graduation-->
                <div class="col-md-6">
                    <div class="jumbotron">
                        ...
                        <form id="register4">
                            <div>
                                <select id="department2" class="form-control" name="department_id" required>
                                    <option disabled selected hidden>SELECT DEPARTMENT</option>
                                ...
                                <select id="degree2" class="form-control" name="degree_id" required>
                                    <option value="" disabled selected>SELECT DEGREE</option>
                                ...
                                <input type="text" name="py" class="my-1 form-control" placeholder="FOR PREVIOUS YEAR" required>
                                <input type="text" name="ly" class="my-1 form-control" placeholder="FOR FINAL YEAR" required>


                                <center><input type="submit" name="sub3" id="submit4" class="my-3 btn btn-outline-info" value="SUBMIT" onclick="formregistration4()" />
