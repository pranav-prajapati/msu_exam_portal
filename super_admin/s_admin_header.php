...
if ($loggedin != true && $superadmin != true) {
...
<div class="sidebar-container">
    ...
    <br>     
    <b class="title">VI-BOH EXAM PORTAL</b>
        <br>
    ...
    <ul class="sidebar-navigation">
        ...
        <li>
            ...
            <i  class="far fa-clock" aria-hidden="true"></i>  EXAM SCHEDULE
            </a>
        </li>
        <li>
      ...
      <i class="fas fa-clipboard-list"></i> SUBJECT ALLOCATION
        ...
        <li>
            ...
            <i class="fas fa-camera"></i> STUDENT DATA
            </a>
        </li>
